...
class ShellEmulator(wx.TextCtrl):
    def __init__(self, parent, path_to_shell, ID_TERMINAL):
        self.parent = parent
        wx.TextCtrl.__init__(self, parent,ID_TERMINAL,pos = (0,0), size = (100,100) ,
                                           style = wx.TE_MULTILINE|wx.RESIZE_BORDER)
        ...
        self.Bind(wx.EVT_CHAR, self.OnTerminalChar,
                                  id = ID_TERMINAL)
        
        self.Bind(wx.EVT_KEY_DOWN, self.OnTerminalKeyDown,
                                  id = ID_TERMINAL)
        
        self.Bind(wx.EVT_KEY_UP, self.OnTerminalKeyUp,
                                  id = ID_TERMINAL)
